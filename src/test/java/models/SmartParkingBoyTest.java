...
import strategies.MaxAvailableSpacesStrategy;
...
public class SmartParkingBoyTest {
    ...
    public void should_pick_the_original_car_when_park_my_car() throws NoAvailableParkingSpace, NoSuchCarInParkingLot {
        SmartParkingBoy boy = new SmartParkingBoy(Arrays.asList(new ParkingLot(1)), new MaxAvailableSpacesStrategy());
        Car myCar = new Car();
    ...
    public void should_not_park_my_car_when_all_parking_spaces_are_full() throws NoAvailableParkingSpace {
        SmartParkingBoy boy = new SmartParkingBoy(Arrays.asList(new ParkingLot(0)), new MaxAvailableSpacesStrategy());
        Car myCar = new Car();
    ...
    public void should_park_my_car_into_parking_lot_with_max_available_spaces() throws NoAvailableParkingSpace, NoSuchCarInParkingLot {
        ...
        SmartParkingBoy boy = new SmartParkingBoy(Arrays.asList(parkingLotWithLessAvailableSpaces, parkingLotWithMaxAvailableSpaces), new MaxAvailableSpacesStrategy());
        Car myCar = new Car();
