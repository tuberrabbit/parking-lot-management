...
import strategies.AvailableSpacesStrategy;
...
public class ParkingBoyTest {
    ...
    public void should_pick_the_original_car_when_park_my_car() throws NoAvailableParkingSpace, NoSuchCarInParkingLot {
        ParkingBoy boy = new ParkingBoy(Arrays.asList(new ParkingLot(1)), new AvailableSpacesStrategy());
        Car myCar = new Car();
    ...
    public void should_not_park_my_car_when_all_parking_spaces_are_full() throws NoAvailableParkingSpace {
        ParkingBoy boy = new ParkingBoy(Arrays.asList(new ParkingLot(0)), new AvailableSpacesStrategy());
        Car myCar = new Car();
    ...
    public void should_only_park_one_parking_lot_when_there_are_many_parking_lots_have_available_spaces() throws NoAvailableParkingSpace, NoSuchCarInParkingLot {
        ...
        ParkingBoy boy = new ParkingBoy(Arrays.asList(parkingLot1, parkingLot2), new AvailableSpacesStrategy());
        Car myCar = new Car();
